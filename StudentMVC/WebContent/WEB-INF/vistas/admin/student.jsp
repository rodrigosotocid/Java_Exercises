...
<div class="row">
	...
	<form action="admin/student" method="post"
		class="offset-xl-3 offset-md-2 offset-sm-1 col-sm-10 col-md-8 col-xl-6 mt-5">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input
						...
						id="nombre" name="nombre" value="${student.nombre}">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text"
						...
						id="url" name="url" value="${student.apellidos}">
					...
					<div class="col-sm-10">
						<div class="form-check">
							<input class="form-check-input" type="radio" name="gridRadios"
								id="sexo" value="male"> <label
								class="form-check-label" for="sexo"> Masculino </label>
						</div>
						<div class="form-check">
							<input class="form-check-input" type="radio" name="gridRadios"
								id="sexo" value="female"> <label
								class="form-check-label" for="sexo"> Femenino </label>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="date"
						...
						id="fecha" name="fecha" value="${student.fechaNacimiento}">
